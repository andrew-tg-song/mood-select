...
export default function NextArrow({ onClick, slidesToShow, type }: NextArrowProps) {
  return (
    <>
      {type === 'detail' ? (
        <div
          onClick={onClick}
          className="text-[1.875rem] text-[white] absolute top-[40%] right-[10px] z-[9999] cursor-pointer"
        >
